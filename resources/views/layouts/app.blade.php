                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="{{route('user.show',['user_id'=>Auth::id()])}}" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                     ...
                                     <a class="dropdown-item" href="{{route('user.show',['user_id'=>Auth::id()])}}"
                                      >
                                        {{ __('个人主页') }}
                                    </a>
